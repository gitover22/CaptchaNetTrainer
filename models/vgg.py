...
def vgg11():
    ...
    vgg11.features[0] = nn.Conv2d(in_channels=1, out_channels=64, kernel_size=(3, 3), stride=(1, 1),
                                         padding=(1, 1))
    vgg11.classifier.add_module("my_Linear", nn.Linear(1000, 62*5))
    return vgg11
...
def vgg13():
    ...
    vgg13.features[0] = nn.Conv2d(in_channels=1, out_channels=64, kernel_size=(3, 3), stride=(1, 1),
                                         padding=(1, 1))
    vgg13.classifier.add_module("my_Linear", nn.Linear(1000, 62*5))
    return vgg13
...
def vgg16():
    ...
    vgg16.features[0] = nn.Conv2d(in_channels=1, out_channels=64, kernel_size=(3, 3), stride=(1, 1),
                                         padding=(1, 1))
    vgg16.classifier.add_module("my_Linear", nn.Linear(1000, 62*5))
    return vgg16
...
def vgg19():
    ...
    vgg19.features[0] = nn.Conv2d(in_channels=1, out_channels=64, kernel_size=(3, 3), stride=(1, 1),
                                         padding=(1, 1))
    vgg19.classifier.add_module("my_Linear", nn.Linear(1000, 62*5))
    return vgg19
